...
import { NeuropsychiatricUpdate, submitDrug } from "./NeuropsychiatricController";
...
export default function Neuropsychiatric() {
  ...
  const fetchData = () => {
    axios
      .get(process.env.REACT_APP_BACKEND_URL + "/api/neuropsychiatric")
      .then((response) => {
  ...
  const handleDelete = async (Medication) => {
    if (window.confirm("Are you sure you want to delete this record?")) {
      try {
        ...
        await axios.delete(process.env.REACT_APP_BACKEND_URL + "/api/Neuropsychiatric/delete/" + Medication);
