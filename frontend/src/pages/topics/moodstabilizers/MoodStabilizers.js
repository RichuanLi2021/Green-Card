...
import {MoodStabilizersUpdate, submitDrug }from './MoodStabilizersController';
...
export default function MoodStabilizers() {
  ...
  const fetchData = () => {
    axios
      .get(process.env.REACT_APP_BACKEND_URL + "/api/moodstabilizers")
      .then((response) => {
  ...
  const handleDelete = async (Name) =>{
    ...
    try{
      ...
      await axios.delete(process.env.REACT_APP_BACKEND_URL + "/api/MoodStabilizers/delete/" + Name)
