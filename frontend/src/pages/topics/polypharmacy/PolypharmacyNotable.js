...
import { PolypharmacyNotableBackendUpdate, submitData } from "./PolypharmacyNotableController";
...
export default function PolypharmacyCommon() {
  ...
  useEffect(() => {
    axios
      .get(process.env.REACT_APP_BACKEND_URL + "/api/polypharmacynotable")
  ...
  const handleDelete = async (Description) => {
    if (window.confirm("Are you sure you want to delete this record?")) {
      try {
        ...
        await axios.delete(process.env.REACT_APP_BACKEND_URL + "/api/PolypharmacyNotable/delete/" + Description);
