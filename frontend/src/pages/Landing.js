  ...
  return (
    ...
    >
      <Container maxWidth="lg" sx={{ textAlign: 'center' }}>
        ...
        <Typography variant="subtitle4" component="h3" sx={{ fontWeight: 'bold', mb: 0}}>
        ...
        <SvgIcon component={GreenShine1024pxIcon} inheritViewBox sx={{ fontSize: 60, mb: 3}} />

        <Typography variant="subtitle2" gutterBottom sx={{ fontWeight: 'bold', mb: 1}}>
          Login For more Drug Information and The Usage. 
        </Typography>

        <Button variant="contained" color="primary" onClick={handleRegister} style={{ marginRight: '1rem' }}>
          Register Now
        </Button>
