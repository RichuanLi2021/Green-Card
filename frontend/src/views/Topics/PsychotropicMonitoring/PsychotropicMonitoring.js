    ...
    return (
      <>
        ...
        <div style={{ marginTop: '3rem', padding: '0 1rem' }}>
          ...
          <footer class="footer">
            <p>Key: ACI: as clinically indicated, BL: baseline, m: month mark (eg. 6m: 6 month mark). NOTE: these are meant to be minimum screening requirements, more frequent investigation may be necessary based on clinical judgment</p>
          </footer>
        </div></>
      );
     }