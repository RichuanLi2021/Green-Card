...
<TableBody>
              ...
              <StyledTableRow  >
                <StyledTableCell ><input
                                ...
                                /></StyledTableCell>
                                 <button style={{background:'none',border:'none',cursor:'pointer',marginTop:'10px'}} onClick={e => handleDelete(dataObj.Description)} > <span class="material-symbols-outlined">
delete
</span></button>
              </StyledTableRow>
