          ...
          <TableBody class="tableBody">
            {rows.map((row) => (
              <StyledTableRow key={row.name} >
                <StyledTableCell  className="nameCell"component="th" scope="row" sx={{ backgroundColor: "rgba(243, 243, 243,1)"}} >
                  {row.name}
                </StyledTableCell>
...
//       <Navigation />
//       <SearchBar placeholder="Search" data={Data} />
//       <div style={{ marginTop: "5.5rem", padding: "0" }}>
//         <Typography variant="h4" align="center" gutterBottom>
//           Antidepressants Guide
//         </Typography>
