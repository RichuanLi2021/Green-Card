  ...
  const update_value = (event) => {
    if (admin) {
      ...
      if (event.target.value !== value) {
        ...
        CognitiveEnhancersGuideContUpdate(event.target.name, event.target.id, event.target.value)
          .then((data) => {
            alert(
        ...
        <>
          ...
          <div style={{ marginTop: "2rem", padding: "0 1rem" }}>
            <Typography variant="h3" align="center" gutterBottom>
              <div className="subtitle">Cognitive Enhancers Guide continued.</div>
            </Typography>
            ...
            <div className="grid-container">
              ...
              <div className="box-content">
                <p>
                  NOTE: THIS PAGE IS A CONTINUATION OF THE DRUG INFORMATION FOR THE SAME DRUGS FROM THE COGNITIVE
                  ENHANCERS GUIDE PAGE. DRUGS MAY BE ADDED OR REMOVED FROM THE COGNITIVE ENHANCERS GUIDE FOR DISPLAY
                  HERE.
                </p>
              </div>
            </div>
            <div className="keynote-div">
              <p className="cognitive-notes">
                <b>Key:</b> DSD: down syndrome dementia; FTD: frontotemporal dementia; LBD: lewy body dementia; MCI:
                mild cognitive impairment; N: not indicated; PD: parkinson's disease; Y: indicated.
              </p>
            </div>
          </div>
          <Footer />
