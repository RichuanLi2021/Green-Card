      ...
      <div>
        ...
        >
          ...
          <AccordionDetails>
            <li>
              {" "}
              Antipsychotic + L-dopa = worsening of Parkinsons, worsening of
              psychosis{" "}
            </li>
        ...
        >
          ...
          <AccordionDetails>
            ...
            <li>
              {" "}
              Falls & fractures Hyperglycemia Mortality (NNH=87) QTc
              prolongation Stroke (NNH=53) Weight gain{" "}
            </li>
          </AccordionDetails>
        </Accordion>
      </div>
