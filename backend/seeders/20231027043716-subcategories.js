...
module.exports = {
  async up (queryInterface, DataTypes) {
    await queryInterface.bulkInsert('subcategories', [
      ...
      { id: 14, uuid: uuidv4(), categoryID: 5, subcategoryTypeID: 2, description: 'Mood Stabilizers Adverse Effects and Safety', createdAt: new Date(), updatedAt: new Date() },
      { id: 15, uuid: uuidv4(), categoryID: 6, subcategoryTypeID: 4, description: 'Neuropsychiatric Symptoms on Dementia Nonpharmalogical', createdAt: new Date(), updatedAt: new Date() },
      { id: 16, uuid: uuidv4(), categoryID: 6, subcategoryTypeID: 5, description: 'Neuropsychiatric Symptoms on Dementia Pharmalogical', createdAt: new Date(), updatedAt: new Date() },
      { id: 17, uuid: uuidv4(), categoryID: 7, subcategoryTypeID: 4, description: 'Delirium Nonpharmalogical', createdAt: new Date(), updatedAt: new Date() },
      { id: 18, uuid: uuidv4(), categoryID: 7, subcategoryTypeID: 5, description: 'Delirium Pharmalogical', createdAt: new Date(), updatedAt: new Date() },
      { id: 19, uuid: uuidv4(), categoryID: 7, subcategoryTypeID: 6, description: 'Delirium Anticholinergic Activity', createdAt: new Date(), updatedAt: new Date() },
      { id: 20, uuid: uuidv4(), categoryID: 8, subcategoryTypeID: 1, description: 'ECT & Psychoactive Medications Medication Table', createdAt: new Date(), updatedAt: new Date() }
    ], {});
  },
