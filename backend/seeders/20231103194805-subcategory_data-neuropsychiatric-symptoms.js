...
module.exports = {
  async up (queryInterface, DataTypes) {
    await queryInterface.bulkInsert('subcategory_headers', [
      ...
      // Neuropsychiatric-symptoms - Nonpharmalogical Approach
      ...
      // Neuropsychiatric-symptoms - Pharmalogical Approach
      { uuid: uuidv4(), headerID: 68, value: 'Only use if clinically signficant distress/agitation/aggression, when benefits>harm, and non pharmacological approach failed', createdAt: new Date(), updatedAt: new Date() },
