...
module.exports = {
  async up (queryInterface, DataTypes) {
    await queryInterface.bulkInsert('subcategory_data', [
      ...
      { uuid: uuidv4(), headerID: 62, value: '-', createdAt: new Date(), updatedAt: new Date() },
      { uuid: uuidv4(), headerID: 63, value: '-', createdAt: new Date(), updatedAt: new Date() },
      { uuid: uuidv4(), headerID: 64, value: '-', createdAt: new Date(), updatedAt: new Date() },
      { uuid: uuidv4(), headerID: 65, value: '-', createdAt: new Date(), updatedAt: new Date() },
      { uuid: uuidv4(), headerID: 66, value: '-', createdAt: new Date(), updatedAt: new Date() },
